...
export default function NavBar({ userName }) {
  ...
  const notification = (
    ...
    >
      <path
        class="b"
        d="M20,37.875a3.51,3.51,0,0,0,3.5-3.5h-7A3.51,3.51,0,0,0,20,37.875Zm10.5-10.5v-8.75c0-5.372-2.853-9.87-7.875-11.06V6.375a2.625,2.625,0,0,0-5.25,0v1.19C12.37,8.755,9.5,13.235,9.5,18.625v8.75L6,30.875v1.75H34v-1.75ZM27,29.125H13v-10.5c0-4.34,2.642-7.875,7-7.875s7,3.535,7,7.875Z"
  ...
  return (
    <div className="w-full bg-green-50 px-16 shadow-green-100 shadow-xl opacity-95 ">
      <div className="md:flex items-center  justify-between py-2.5 md:px-10 px-7">
        <div className="font-bold text-2xl cursor-pointer flex items-center font-[Poppins] text-gray-800">
          <Link href="/">
            <Image
              src={require("../../assets/xchangelogo.png")}
              alt="logo"
              width={154}
              height={57}
            />
        ...
        <ul
          className={`flex gap-8 sm:gap-0 justify-center items-center md:pb-0 mt-4 md:mt-0 bg-green-button md:bg-green-50 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto  md:pl-0  transition-all duration-500 ease-in ${
            open ? "top-16 " : "top-[-190px]"
          }`}
        >
          <li className="md:ml-8 p-[-25px] text-xl md:my-0 my-2">
            <a
              href={"/"}
          ...
          <li className="md:ml-8 text-xl md:my-0 my-7">
            <a
              ...
              className="text-gray-800 hover:text-gray-400 duration-500"
            >
              <p className="text-secondary text-xl font-bold  pl-2">
                {userName || null}
              </p>
            </a>
          </li>
